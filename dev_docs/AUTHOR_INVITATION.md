...
One phrase is deliberate and should survive reuse: "no dynamical field **at start**". That is the state M8 was accepted in, not a verdict on the model. Supplying the equation of motion became the program: the [field-dynamics pre-registration](../openwave/xperiments/m8_mit/research/findings/m8_2_preregistration.md) was locked by the author's own first pull request, and the Lagrangian-family survey it governs is the column's decisive science. Where that stands on the day of writing is in the [M8 roadmap](../openwave/xperiments/m8_mit/research/m8_roadmap.md); do not restate it here.
