...
| Magnetic moment μ (g ≈ 2) | intrinsic magnetostatics: a stationary state sources a static dipole B from internal circulation, g ≈ 2; dipole Larmor response |
...
| Magnetic moment μ (g ≈ 2) | 🚧 [not yet tested]<br>No per-defect magnetic moment computed; the framework carries magnetism only in the A_μ Maxwell sector by construction (see EM waves)<br>(none yet) |
