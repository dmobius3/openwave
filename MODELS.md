...
| Gravity: Newton limit (GEM) | ⚠️ partially validated — 1/r² form from EMC gradient-overlap geometry; normalization-consistency gate, not a strength derivation (G cancels through A and K_emc); strength not credited per criterion's own clause (M4.10) |
