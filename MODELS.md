...
| ⚠️ partial / with caveats | 11 | 10 | 10 | 2 | 1 | 1 |
| ❌ honest negative | 2 | 0 | 3 | 3 | 0 | 0 |
| 🚧 planned / not tested | 9 | 21 | 18 | 23 | 30 | 30 |
...
| Gravity: Newton limit (GEM) | ⚠️ | 🚧 | ⚠️ | 🚧 | 🚧 | 🚧 | both |
...
| Gravity: Newton limit (GEM) | ⚠️ [partially validated]<br>Enhanced EWT extension (Ł. Smoliński): EMC gradient-overlap geometry gives 1/r² form; negative-definite energy functional yields attractive sign; normalization-consistency gate, not a strength derivation (G cancels through A and K_emc); strength not credited per criterion's own clause (M4.10)<br>[`m4_10_newtonian_force_emc.py`](openwave/xperiments/m4_ewt/research/scripts/m4_10_newtonian_force_emc.py), [`m4_10_newtonian_force_emc.md`](openwave/xperiments/m4_ewt/research/findings/m4_10_newtonian_force_emc.md) |
...
| Particle stability (Derrick escape) | 🚧 [not yet tested]<br>Not applicable in current MIT (no soliton; stability asserted spectrally via the double-cover return); whether a field dynamics on S³/2I has stable localized states was M8.4's core question. M8.4 CLOSED UNRESOLVED 2026-08-26; the successor chassis reached `M8.5-C2-FAILED` 2026-08-31, closing the reopening path. Untested, and no authorised route to it currently exists<br>[`m8_background.md`](openwave/xperiments/m8_mit/research/m8_background.md) |
...
| Lorentz covariance (+ Coulomb = EM) | 🚧 [not yet tested]<br>Not applicable yet: no field dynamics to be covariant; supplying a field equation on S³/2I was the M8.4 program, CLOSED UNRESOLVED 2026-08-26. The target-free successor chassis has ended: `M8.5-C2-FAILED` 2026-08-31, instrument-attributed STOP-QUAL, no gate measured red and the attribution is to the commissioned unit's conduct, closing the spectral route and the M8.4 reopening path. No authorised route currently exists<br>[`m8_background.md`](openwave/xperiments/m8_mit/research/m8_background.md) |
