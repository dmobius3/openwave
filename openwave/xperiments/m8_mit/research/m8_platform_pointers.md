...
| [M5.21.11](../../m5_liquid_crystal/research/tasks/m5_21_11_task_details.md) | the bridge M8.6 waits on: the realistic-parameter walk plus unit calibration that would produce a physically parameterized census to compare against. Its route-(b) pre-registration artifact lives at [`m5_21_11_framework.md`](../../m5_liquid_crystal/research/findings/m5_21_11_framework.md) (§ 8 there maps each § 8 condition to the section satisfying it; the artifact's own status header states whether it is frozen yet) |
