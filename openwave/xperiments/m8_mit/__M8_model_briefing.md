...
| M8.5 | Quotient-manifold simulation engineering. Grid built and adjudicated; the spectral half ran M8.5-C (attempt A1 terminated without adjudication on a frozen-arm defect, #501) and is now M8.5-C2: the derived successor protocol FILED 2026-08-29 and frozen at merge, its Build Unit commissioning next |
