...
import openwave.xperiments.m2_free_wave.medium as medium
import openwave.xperiments.m2_free_wave.wave_engine as ewave
import openwave.xperiments.m2_free_wave.utils.instrumentation as instrument
...
def compute_wave_oscillation(state):
    ...
    state.ampL_global_rms = (
        state.trackers.ampL_global_emarms_am[None] * constants.ATTOMETER
    )  # in m
    state.ampT_global_rms = (
