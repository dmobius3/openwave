...
**Source:** Duda, *Framework for liquid crystal based particle models* (arxiv:2108.07896 v7), §II-IV + Fig.9 (math reading **confirmed by the maintainer 2026-05-26**); Wabnig, Resch, Theuerkauf, Anmasser & Faber, *Universe* **11**(4):113 (2025), [DOI 10.3390/universe11040113](https://doi.org/10.3390/universe11040113) (regularization, §5c; author list corrected 2026-07-25, previously miscredited here as "Faber & Golubich").
...
Faber's *Model of Topological Fermions* (the [hep-th/9910221](https://arxiv.org/abs/hep-th/9910221) lineage; numerical soliton-pair evaluation in Wabnig, Resch, Theuerkauf, Anmasser & Faber, *Universe* **11**(4):113, 2025) gives the
...
The maintainer's M5.5.4 on-screen observation: with V off, Evolve-PDE makes the hedgehog *slosh*
...
So the reframe (the maintainer 2026-05-28): drop external seeding and ask whether the defect's **own**
...
**Kinetic term (derived 2026-05-26, confirmed by the maintainer).** The "electric"/time curvature
parallels Eq.20:
