...
| The instrument identity | ✅ E_full is numerically the SAME array the M5.22.1 moments called B: under the paper's dual mapping the M5.22.1 moment values stand as electric-sector reads. ✅ The dual mapping author-CONFIRMED 2026-08-06 (E = the spatial F components; [convo § 2026-08-06](m5_22_convo.md)); the full-F variant (all eigen-contributions) staged as the [M5.22.4](m5_22_4_task_details.md) opening add-on |
