...
| [M4.10](tasks/m4_10_task_details.md) | Newtonian force from EMC field overlap | Angular integration of two EMC deficits gives 4π/r² outside the separation and 0 inside, so U ∝ 1/R and F ∝ 1/R². G, c, M and R cancel identically in `F_emc ≡ F_Newton`, leaving a normalization gate on A, `K_emc` and 4π; mutating each reddens it 25-100%. No cell change. Contributed by Łukasz Smoliński, [PR #495](https://github.com/openwave-labs/openwave/pull/495) | 2026-08-28 |
