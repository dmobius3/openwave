...
| [M4.7](tasks/m4_7_task_details.md) | Enhanced EWT geometric consistency suite | Python port of the Scilab suite (G, α⁻¹, lepton AMMs, masses, mixing angles, atomic scales, `r_ν`, `g_v`), a foundation artifact for later tasks, no criterion claimed. With geometric constants: G to 4.78 ppm, α⁻¹ to 1.9e-6, `a_e` to 2.3e-4; the 13-digit G uses a calibrated `L_p`. Contributed by Łukasz Smoliński, [PR #477](https://github.com/openwave-labs/openwave/pull/477) | 2026-08-25 |
...
| [M4.10](tasks/m4_10_task_details.md) | Newtonian force from EMC field overlap | Angular integration of two EMC deficits gives 4π/r² outside the separation and 0 inside, so U ∝ 1/R and F ∝ 1/R². G, c, M and R cancel identically in `F_emc ≡ F_Newton`, leaving a normalization gate on A, `K_emc` and 4π; mutating each reddens it 25-100%. Cell updated to ⚠️ partially validated. Contributed by Łukasz Smoliński, [PR #495](https://github.com/openwave-labs/openwave/pull/495) | 2026-08-28 |
