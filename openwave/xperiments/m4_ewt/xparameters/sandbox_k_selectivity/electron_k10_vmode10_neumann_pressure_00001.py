# electron_k10_vmode10_neumann_pressure_00001.py
"""
K=10, 1-3-6 geometry, Neumann interaction, V_MODE=10, WC_BOOST=0.015.
Vacuum pressure force enabled (PRESSURE_STRENGTH=0.0001).
Tests whether the pressure force improves K-selectivity by pulling WCs inward.
"""
...
XPARAMETERS = {
    "meta": {
        "X_NAME": "K=10 1-3-6 Neumann boost=0.015 V_MODE=10 pressure=0.0001",
        "DESCRIPTION": "Pressure force test: does vacuum pressure improve soliton stability?",
    },
