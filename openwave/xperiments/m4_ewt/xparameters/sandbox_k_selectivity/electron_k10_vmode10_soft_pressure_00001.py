...
Tests whether the pressure force improves soliton stability in the soft mode.
"""
...
XPARAMETERS = {
    "meta": {
        "X_NAME": "K=10 1-3-6 soft boost=0.00001 V_MODE=10 pressure=0.0001",
        "DESCRIPTION": "Pressure force test in soft mode: does it improve stability?",
    },
