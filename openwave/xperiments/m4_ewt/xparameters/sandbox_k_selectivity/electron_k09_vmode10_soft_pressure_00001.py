# electron_k09_vmode10_soft_pressure_00001.py
"""
K=9, golden-angle geometry, soft interaction, V_MODE=10, ultra-low boost.
Vacuum pressure force enabled (PRESSURE_STRENGTH=0.0001).
Tests whether the pressure force accelerates the decay of metastable K=9.
"""
...
XPARAMETERS = {
    "meta": {
        "X_NAME": "K=9 golden-angle soft boost=0.00001 V_MODE=10 pressure=0.0001",
        "DESCRIPTION": "K-selectivity pressure test: K=9 with vacuum pressure force",
    },
