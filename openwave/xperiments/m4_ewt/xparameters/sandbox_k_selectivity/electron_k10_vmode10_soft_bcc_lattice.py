# electron_k10_vmode10_soft_bcc_lattice.py
"""
K=10, BCC lattice geometry, soft interaction, V_MODE=10.
...
XPARAMETERS = {
    "meta": {
        "X_NAME": "K=10 BCC lattice soft boost=0.00001 V_MODE=10",
        "DESCRIPTION": "K-selectivity control: K=10 with BCC lattice geometry in soft mode",
    },
