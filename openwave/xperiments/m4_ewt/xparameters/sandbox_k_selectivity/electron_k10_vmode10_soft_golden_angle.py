# electron_k10_vmode10_soft_golden_angle.py
"""
K=10, golden-angle phyllotaxis, soft interaction, V_MODE=10.
Control test: is the 1-3-6 geometry unique even for K=10?
Uses the same stable parameters as the 1-3-6 soft-mode test.
"""
...
POSITIONS = golden_angle_positions(K, RADIUS, center=(0.5, 0.5, 0.5))
PHASES = [180] * K

XPARAMETERS = {
    "meta": {
        "X_NAME": "K=10 golden-angle soft boost=0.00001 V_MODE=10",
        "DESCRIPTION": "K-selectivity control: K=10 with golden-angle geometry in soft mode",
    },
