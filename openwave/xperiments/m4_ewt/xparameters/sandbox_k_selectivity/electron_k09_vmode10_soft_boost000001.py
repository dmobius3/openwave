# electron_k09_vmode10_soft_boost000001.py
"""
K=9, golden-angle geometry, soft interaction, V_MODE=10, ultra-low boost.
K-selectivity test: K=9 with soft mode and V_MODE=10.
"""
...
XPARAMETERS = {
    "meta": {
        "X_NAME": "K=9 golden-angle soft boost=0.00001 V_MODE=10",
        "DESCRIPTION": "K-selectivity test: K=9 with soft mode and V_MODE=10",
    },
