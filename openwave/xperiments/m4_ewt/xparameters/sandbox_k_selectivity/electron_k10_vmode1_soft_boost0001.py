# electron_k10_vmode1_soft_boost0001.py
"""
K=10, 1-3-6 geometry, soft interaction, WC_BOOST=0.001, damping=0.95.
Step 2: higher boost with stronger damping to find equilibrium.
"""
...
XPARAMETERS = {
    "meta": {
        "X_NAME": "K=10 1-3-6 soft boost=0.001 damp=0.95",
        "DESCRIPTION": "Soft mode - higher boost with stronger damping",
    },
