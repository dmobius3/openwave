# electron_k09_vmode1_neumann_boost0015.py
"""
K=9, golden-angle geometry, neumann interaction, WC_BOOST=0.015.
K-selectivity test: if K=10 is the only stable configuration,
K=9 should show different behavior.
"""
...
XPARAMETERS = {
    "meta": {
        "X_NAME": "K=9 golden-angle neumann boost=0.015",
        "DESCRIPTION": "K-selectivity test: K=9 with equilibrium parameters",
    },
