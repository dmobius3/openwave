...
XPARAMETERS = {
    "meta": {
        "X_NAME": "Electron K=10 pressure force (V_MODE=6)",
        "DESCRIPTION": "Flat density profile + vacuum pressure binding force",
    },
    "camera": {
...
"engine": {
    ...
    "SIGMA": 8.0,
    "DEFICIT_DEPTH": 0.9,
    "PRESSURE_STRENGTH": 0.05,   # 10× silniejsze
},
    "ui_defaults": {
        "SHOW_AXIS": False,
        "TICK_SPACING": 0.25,
