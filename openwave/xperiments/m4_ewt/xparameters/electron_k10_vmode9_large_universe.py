# electron_k10_vmode9_large_universe.py
from openwave.xperiments.m4_ewt.xparameters.formation02 import generate_K_positions
from openwave.common import constants

# ================================================================
# 2× WIÊKSZA DOMENA – opóŸnia odbicia od brzegów
# ================================================================
UNIVERSE_EDGE = 2e-15  # zamiast 1e-15
...
XPARAMETERS = {
    "meta": {"X_NAME": "Electron K=10 V_MODE=9 LARGE UNIVERSE (2e-15)"},
    ...
    "engine": {
        "SEED_MODE": 2,
        "SEED_BOOST": 0.02,
        "V_MODE": 9,                     # gaussowski – najlepszy
        "V_C1": -0.5,                    # s³abe ogniskowanie
        "V_C2": 0.0,
        "WC_INTERACT_MODE": 0,
        "WC_BOOST": 1.0,
        "WC_RADIUS": 2,
