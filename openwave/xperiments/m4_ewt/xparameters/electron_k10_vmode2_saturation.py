...
XPARAMETERS = {
    "meta": {"X_NAME": "Electron K=10 V_MODE=2 strong saturation (c2=0.05)"},
    ...
    "engine": {
        "SEED_MODE": 2,
        "SEED_BOOST": 0.01,
        "V_MODE": 2,                     # kwintyka nasycaj¹ca
        "V_C1": -0.5,                    # s³absze ogniskowanie (mniejszy gradient energii)
        "V_C2": 0.05,                    # 5× silniejsze nasycenie ni¿ poprzednio
        "WC_INTERACT_MODE": 0,
        "WC_BOOST": 1.0,
        "WC_RADIUS": 2,
        "WC_SIGMA": 1.5,
