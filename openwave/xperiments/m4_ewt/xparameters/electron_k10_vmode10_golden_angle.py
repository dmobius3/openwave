...
# K=10: Golden angle phyllotaxis on a sphere (NOT 1-3-6)
# ================================================================
UNIVERSE_EDGE = 2e-15
...
# Golden angle on a sphere with radius ~0.35 * LOCK_SPACING
...
XPARAMETERS = {
    "meta": {
        "X_NAME": "Electron K=10 V_MODE=10 GOLDEN ANGLE (NOT 1-3-6)",
        "DESCRIPTION": "K=10 golden angle phyllotaxis, control test",
    },
    "camera": {
