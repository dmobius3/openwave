...
| File | Provenance |
| --- | --- |
| `00`–`03` | Author `.tex` from the 7 August 2026 program archive (matches the FINAL PDFs) |
| `04`–`10` | Reconstructed from the 14 August 2026 FINAL PDFs (no author `.tex` was in the archives) |
