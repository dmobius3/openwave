...
| A2 local-\(X\) modular ansatz | ⚠️ local hop is CHM-type (Paper 25). Horizon first law: a radial weight beats flat (Papers 27, 29); the parabola is not selected over \(R-r\) (Paper 29, tie). Tracking floors fail. [`research/findings/m9_20_horizon_shape_note.md`](research/findings/m9_20_horizon_shape_note.md) |
