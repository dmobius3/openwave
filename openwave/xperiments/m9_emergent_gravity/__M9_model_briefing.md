...
| A2 local-\(X\) modular ansatz | ⚠️ not refuted on 1d/2d/3d lattice Dirac or on a \(3+1\)D diamond waist (two spacings, fine ratios \(\le 1.19\), auditor CONFIRMED). Not \(a\to 0\), not the SM. [`research/findings/m9_13_A2_diamond_note.md`](research/findings/m9_13_A2_diamond_note.md) |
| A1 UV coefficient | ✅ `[P]` for this 1d fermion: \(\alpha(0)=0.323\), UV drift \(<8\%\). Not \(1/4G\) |
