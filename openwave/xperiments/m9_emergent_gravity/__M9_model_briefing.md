...
| A2 local-\(X\) modular ansatz | ⚠️ not refuted on 1d/2d/3d lattice Dirac (2d ratios \(\le 1.38\), auditor CONFIRMED). 1d scalar instrument rejected (\(\xi\) clipped). Not a 4d theorem. [`research/findings/m9_12_A2_dirac_note.md`](research/findings/m9_12_A2_dirac_note.md) |
