...
| A2 local-\(X\) modular ansatz | ⚠️ not refuted on 1d/2d/3d lattice Dirac or on a \(3+1\)D diamond waist. The local *hop* is the CHM envelope (\(\rho=-0.987\), auditor CONFIRMED). Not \(1/4G\). [`research/findings/m9_15_chm_shape_note.md`](research/findings/m9_15_chm_shape_note.md) |
