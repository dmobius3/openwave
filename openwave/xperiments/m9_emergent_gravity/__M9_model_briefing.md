...
| A2 local-\(X\) modular ansatz | ⚠️ 1d free fermion: not refuted (\(R(m)/R(0)\le 1.32\) in the locked window). Not a 4d theorem. [`research/findings/m9_10_A2_A1_note.md`](research/findings/m9_10_A2_A1_note.md) |
