...
import openwave.xperiments.m1_granule_motion.utils.instrumentation as instrument
...
class XperimentManager:
    ...
    def load_xperiment(self, xperiment_name):
        ...
        """
        try:
            module_path = f"openwave.xperiments.m1_granule_motion.xparameters.{xperiment_name}"
